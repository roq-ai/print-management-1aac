...
import { getDesignDraftById } from 'apiSdk/design-drafts';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Design Draft Detail View
          </Text>
          {hasAccess('design_draft', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/design-drafts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
